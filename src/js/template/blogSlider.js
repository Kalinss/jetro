export default function () {
    return `<div class="blog-item blog__item">
	<div class="blog-item__content">
		<div class="blog-item__decor blog-item__decor--slider blog-item__slider">
			<div class="js-blog-slider">
				<div class="blog-item__img"><img src="images/136e6eff8a755734d06ea8e1a507aab4.png"></div>
				<div class="blog-item__img"><img src="images/136e6eff8a755734d06ea8e1a507aab4.png"></div>
			</div>
			<div class="blog-item__button blog-item__button--next js-next">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 52" width="36" height="52">
					<g>
						<g>
							<path fill="#fff"
							      d="M 9.633 52.001 L 35.455 26 L 9.633 0 L 0.001 9.563 L 16.324 26 L 0 42.436 Z"></path>
						</g>
					</g>
				</svg>
			</div>
			<div class="blog-item__button blog-item__button--prev js-prev">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 52" width="36" height="52">
					<g>
						<g>
							<path fill="#fff"
		...
		<div class="blog-description blog-item__blog-description">
			<div class="blog-description__inf clearfix">
				<div class="blog-description__box"><h5 class="blog-description__heading">date</h5><span
			...
			<div class="blog-description__text-wrap"><h4
				...
				<div class="blog-description__text"><p>Lorem ipsum dolor sit amet, sit an molestie neglegentur
					...
					possim imperdiet consequuntur. Brute ipsum tincidunt vim ei. Ne eos vidisse
					splendide instructior. Mei no latine praesent forensibus, te sed habemus tacimates,
					ad ipsum officiis constituto usu.</p>
					<p>Maecenas ipsum metus, semper hendrerit varius mattis, congue sit amet tellus. Aliquam
						...
						nec, pellentesque vel nunc. Cras varius fermentum iaculis ...</p></div>
			</div>
		</div>
